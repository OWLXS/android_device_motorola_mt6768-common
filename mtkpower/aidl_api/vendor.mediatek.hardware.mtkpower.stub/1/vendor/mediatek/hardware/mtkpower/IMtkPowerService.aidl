...
interface IMtkPowerService {
  ...
  int perfLockAcquire(int handle, int duration, in int[] boostsList, int reserved, int reserved2);
  ...
  int setMtkScnUpdateCallback(int scenario, in vendor.mediatek.hardware.mtkpower.IMtkPowerCallback callback);
